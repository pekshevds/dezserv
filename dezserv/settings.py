"""
Django settings for dezserv project.
...
SECRET_KEY = ')+4+(j)^c7-4-iu0ip1&@n$i)-#i&proj^k7&wys@0!bxt_=4%'
...
ROOT_URLCONF = 'dezserv.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'dezserv/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'dezserv.wsgi.application'
